...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call(ComisionPermissionSeeder::class);
        $this->call(SimpsonFamiliesSeeder::class);
        $this->call(SessionDataSeeder::class);

        $permisosFamilia = Permiso::query()->whereIn('nombre', ['Ver familias', 'Gestionar familias', 'Gestionar listas'])->get();
        $coordinador?->permisos()->syncWithoutDetaching($permisosFamilia->pluck('id_permiso'));
        $administrador?->permisos()->syncWithoutDetaching($permisosFamilia->pluck('id_permiso'));
    }
}
